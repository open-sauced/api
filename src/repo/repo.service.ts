...
export class RepoService {
  ...
  async findAllWithFilters(pageOptionsDto: RepoSearchOptionsDto): Promise<PageDto<DbRepo>> {
    ...
    const queryBuilder = this.baseFilterQueryBuilder(startDate, range);
    ...
    const countQueryBuilder = this.baseFilterQueryBuilder(startDate, range).select("repos.id", "repos_id");
