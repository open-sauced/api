...
-- indexes
create index repos_idx_size on repos (size);
create index repos_idx_is_fork on repos (is_fork desc);
create index repos_idx_is_private on repos (is_private desc);
create index repos_idx_is_template on repos (is_template desc);
create index repos_idx_is_archived on repos (is_archived desc);
create index repos_idx_is_disabled on repos (is_disabled desc);
create index repos_idx_has_issues on repos (has_issues);
create index repos_idx_has_projects on repos (has_projects);
create index repos_idx_has_downloads on repos (has_downloads);
create index repos_idx_has_wiki on repos (has_wiki);
create index repos_idx_has_pages on repos (has_pages);
create index repos_idx_has_discussions on repos (has_discussions);
create index repos_idx_issues on repos (issues);
create index repos_idx_stars on repos (stars);
create index repos_idx_forks on repos (forks);
create index repos_idx_watchers on repos (watchers);
create index repos_idx_subscribers on repos (subscribers);
create index repos_idx_network on repos (network);
create index repos_idx_deleted_at on repos (deleted_at);
create index repos_idx_last_fetched_repos_at on repos (last_fetched_repos_at);
create index repos_idx_last_fetched_prs_at on repos (last_fetched_prs_at);
create index repos_idx_last_fetched_commits_at on repos (last_fetched_commits_at);
create index repos_idx_last_fetched_contributors_at on repos (last_fetched_contributors_at);
create index repos_idx_default_branch on repos (default_branch);
create index repos_idx_name on repos (name);
create index repos_idx_full_name on repos (full_name);
create index repos_idx_language on repos (language);
create index repos_idx_license on repos (license);

-- permissions
alter table if exists public.repos owner to postgres;
